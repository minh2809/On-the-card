...
const SignUp = () => {
  ...
  const databaseWork = async () => {
    ...
    if (error) {
      ...
      const socialMediaList = [
        {
          icon: "facebook",
          title: "25 FIT's Facebook",
          url: "https://www.facebook.com/25fitcareer",
        },
        {
          icon: "linkedin",
          title: "25 FIT's Linkedin",
          url: "https://www.linkedin.com/company/25fit/",
        },
      ];
  ...
  return (
    <div className={classes.loginContent}>
      <Helmet>
        <title>25 FIT x ONTHECARD</title>
      </Helmet>
