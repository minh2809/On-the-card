...
import { setBgImgEnterprise } from "../../../store/actionCreators";
...
const BgImgEnterprise = ({ noBgImg }) => {
  ...
  } = useSelector((state) => state.enterprisePage);
  ...
  useEffect(() => {
    ...
    if (currentBgImg) {
      ...
      dispatch(setBgImgEnterprise(currentBgImg));
    }
          ...
          () => {
            firebase.storage
              ...
              .then((url) => {
                ...
                dispatch(setBgImgEnterprise(url));
...
export default BgImgEnterprise;
